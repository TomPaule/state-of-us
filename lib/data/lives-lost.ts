...
why: '',  chartLabel: 'Cardiovascular deaths (thousands per year)',
  ...
  mechanismBullets: [
    '**Blood volume surge:** Excess body fat increases blood volume, forcing the heart to pump harder and raising blood pressure — damaging arterial walls over years until the heart fails or an artery ruptures. Think of it like running a pump at maximum pressure 24 hours a day — eventually something gives.',
    '**Visceral inflammation:** Visceral fat (fat around organs) secretes inflammatory chemicals that accelerate atherosclerosis — the arterial plaque buildup that directly causes heart attacks and strokes. Like rust forming inside a pipe, narrowing the flow until it blocks entirely.',
  ],
  whyBullets: [
    '**42% vs 24%:** The US obesity rate is nearly double the OECD average — the gap has widened every decade since 1980',
    '**Same genetics, different outcomes:** Peer nations have similar genetics and similar nutritional knowledge — the difference is the food environment, shaped by subsidy policy, marketing regulation, and urban design',
    '**Not a willpower problem:** This is not explained by individual choices — it is a predictable outcome of structural conditions that make unhealthy food cheap, abundant, and aggressively marketed',
  ],
  ...
  source: 'CDC BRFSS, OECD Health Statistics',
          sourceUrl: 'https://www.cdc.gov/brfss/index.html',
  ...
  trust: {
    ...
    howToUse: 'Strong foundation — use this figure with confidence. Unlike self-reported surveys, NHANES physically measures participants, eliminating the underestimation bias common in other obesity data. The 42% figure is a reliable estimate.',
    checklist: {
      peerReviewed: true,
      replicated: true,
      largeSampleSize: true,
      sampleSizeDetail: '5,000+ adults measured annually with physical examination',
      noConflictsOfInterest: true,
      conflictsDetail: 'CDC is a federal agency with no commercial interest in obesity data',
      causalEvidence: false,
      systematicReview: false,
      recentData: true,
      recencyDetail: 'Updated every 2 years — most recent data 2017-2020',
      generalizablePopulation: true,
      populationDetail: 'Nationally representative sample with oversampling of minorities',
      effectSizeReported: false,
      fundingDisclosed: true,
      fundingDetail: 'Federal government — CDC budget publicly available',
          ...
          subsections: [
            {
              ...
              issueClaim: 'Obesity is primarily driven by hormonal disruption — not willpower failure. The same biology that causes weight gain actively resists weight loss, making personal responsibility an insufficient explanation for the epidemic.',
              issueEvidence: [
                {
                  id: 'ie-leptin-ghrelin',
                  claim: 'Leptin and ghrelin disruption drives weight regain',
                  finding: 'Once obesity is established, leptin (satiety hormone) becomes less effective and ghrelin (hunger hormone) increases — the body defends its higher weight set point the same way a thermostat defends a temperature. This is documented hormonal adaptation, not character failure.',
                  ...
                  grade: 'A',
                  gradeExplanation: 'Landmark peer-reviewed study in the New England Journal of Medicine. Replicated in 40+ independent studies across different populations. No industry funding. Findings are not contested clinically.',
                },
                {
                  id: 'ie-weight-regain',
                  claim: '80% of people who lose significant weight regain it within 5 years',
                  finding: 'Not willpower failure — documented hormonal opposition. Meta-analysis of 29 independent studies across different populations confirms this is a biological phenomenon, not a motivational one.',
                  source: 'American Journal of Clinical Nutrition, 2014 — meta-analysis of 29 studies',
                  sourceUrl: 'https://academic.oup.com/ajcn/article/99/1/5/4577499',
                  grade: 'A',
                  gradeExplanation: 'Meta-analysis of 29 independent studies — the strongest form of evidence in medicine. Published in a top-tier peer-reviewed nutrition journal. Findings replicated across multiple populations and time periods.',
                },
                {
                  id: 'ie-genetics-environment',
                  claim: 'Genes haven\'t changed but obesity rates tripled — the food environment triggers genetic predispositions',
                  finding: '70% of obesity risk is heritable, but human genes have not meaningfully changed in 50 years while obesity rates have tripled. This proves the food environment is triggering genetic predispositions previously unexpressed — the genes load the gun, the environment pulls the trigger.',
                  source: 'Nature Reviews Genetics, Loos & Yeo, 2022',
                  sourceUrl: 'https://www.nature.com/articles/s41576-021-00414-z',
                  grade: 'A',
                  gradeExplanation: 'Review of genome-wide association studies in Nature Reviews Genetics — one of the highest-impact journals in genetics. Synthesizes findings from studies involving millions of participants. Not contested.',
                },
              ],
              solutionClaim: 'GLP-1 medications (Ozempic, Wegovy) directly address the hormonal disruption that causes obesity — achieving 15-22% sustained weight loss compared to 5-8% from behavioral interventions alone. The science is solved. Access is the remaining problem.',
              solutionEvidence: [
                {
                  id: 'se-step-trials',
                  claim: 'GLP-1 medications achieve 15-22% sustained weight loss',
                  finding: 'Phase 3 randomized controlled trials — the gold standard for medical evidence. 1,961 participants. 15-22% sustained weight reduction at 2 years. Far exceeds any previous pharmacological or behavioral intervention. FDA approval based on this evidence.',
                  source: 'NEJM STEP 1 trial, Wilding et al., 2021',
                  sourceUrl: 'https://www.nejm.org/doi/full/10.1056/NEJMoa2032183',
                  grade: 'A',
                  gradeExplanation: 'Phase 3 RCT — gold standard evidence. Large sample size (1,961 participants). Industry funded by Novo Nordisk but independently replicated in academic settings. FDA approval based on this evidence base.',
                },
                {
                  id: 'se-access-gap',
                  claim: '$1,000/month cost without insurance creates a two-tier system',
                  finding: 'Ozempic costs $1,349/month in the US vs $59/month in Denmark for the same drug. The price difference is entirely policy — not manufacturing cost. The people most harmed by the food system that causes obesity are the least able to access the treatment.',
                  ...
                  grade: 'A',
                  gradeExplanation: 'Kaiser Family Foundation is a nonpartisan health policy research organization with no commercial interests. Primary research using manufacturer pricing data and insurance coverage records. Widely cited by policymakers across party lines.',
                },
              ],
              options: [
                {
                  id: 'opt-medicare-coverage',
                  label: 'Extend Medicare/insurance coverage of GLP-1 medications (S. 2407)',
                  isOptimal: true,
                  pros: [
                    {
                      label: 'Highest coverage reach for highest-risk population',
                      explanation: 'CBO modeling shows S. 2407 covers 3.4M Medicare patients — more than any alternative at comparable cost. Targets the population with highest cardiovascular risk from obesity.',
                      source: 'CBO Score 2024',
                      sourceUrl: 'https://www.cbo.gov',
                      grade: 'A',
                    },
                    {
                      label: 'Net cost positive within a decade',
                      explanation: 'Obesity costs Medicare $172B annually in downstream conditions. Coverage reduces downstream costs enough to offset the $35B 10-year coverage cost. Similar to how statin coverage reduced cardiovascular hospitalization costs.',
                      source: 'NEJM cost-effectiveness analysis, 2023',
                      sourceUrl: 'https://www.nejm.org',
                      grade: 'A',
                    },
                    {
                      label: 'Addresses the biology directly',
                      explanation: 'GLP-1 medications are the only intervention shown to overcome the hormonal resistance documented above. Behavioral interventions achieve 5-8% weight loss vs 15-22% with GLP-1s.',
                      source: 'NEJM STEP trials vs Look AHEAD trial — direct comparison',
                      grade: 'A',
                    },
                  ],
                  cons: [
                    {
                      label: '$35B 10-year cost is real',
                      explanation: 'Real upfront cost before downstream savings materialize. Timeline of net savings is contested — some models show break-even at 7 years, others at 12 years.',
                      source: 'CBO Score 2024',
                      sourceUrl: 'https://www.cbo.gov',
                      grade: 'A',
                    },
                    {
                      label: 'Benefits Novo Nordisk significantly without price negotiation',
                      explanation: 'Without drug price negotiation, coverage expansion increases Novo Nordisk revenue substantially. S. 2407 is stronger combined with the Inflation Reduction Act drug price negotiation mechanism.',
                      source: 'KFF analysis, 2024',
                      grade: 'B',
                    },
                  ],
                },
                {
                  id: 'opt-market-prices',
                  label: 'Let prices fall naturally through market competition',
                  pros: [
                    {
                      label: 'No government spending required',
                      explanation: 'Market competition historically drives price reduction without taxpayer cost. Works well for off-patent generics.',
                      source: 'Historical drug pricing data — FDA generic drug program',
                      grade: 'A',
                    },
                    {
                      label: 'Creates long-term affordability',
                      explanation: 'Generic semaglutide will eventually reach $100-200/month — sustainable without ongoing government coverage once patents expire.',
                      source: 'Modeled estimates based on generic drug pricing patterns — RAND 2023',
                      grade: 'B',
                    },
                  ],
                  cons: [
                    {
                      label: 'Generics are 10+ years away',
                      explanation: 'Novo Nordisk\'s patents protect semaglutide until 2032-2035. No financial incentive to lower prices while demand is high and no competition exists.',
                      source: 'USPTO patent records — semaglutide patent filings',
                      grade: 'A',
                    },
                    {
                      label: 'Wrong timeframe for current patients',
                      explanation: '3.4M Medicare patients with obesity need access now — not in a decade. Cardiovascular damage from obesity accumulates continuously while waiting for market forces to act.',
                      source: 'ACC cardiovascular risk progression data, 2023',
                      grade: 'A',
                    },
                  ],
                },
                {
                  id: 'opt-hsas',
                  label: 'Health Savings Accounts (HSAs)',
                  pros: [
                    {
                      label: 'Preserves individual choice — no mandate',
                      explanation: 'Individuals control their healthcare dollars without government prescription of what to cover. Consistent with the principle that medical decisions belong to individuals and their doctors.',
                      source: 'Heritage Foundation HSA analysis — ideologically consistent position',
                      grade: 'B',
                    },
                    {
                      label: 'Works well for working-age middle-income earners',
                      explanation: 'HSA-eligible plans show good coverage uptake and satisfaction for people with sufficient income to fund them.',
                      source: 'KFF HSA survey, 2023',
                      grade: 'A',
                    },
                  ],
                  cons: [
                    {
                      label: 'Medicare recipients cannot have HSAs by law',
                      explanation: 'IRS rules prohibit Medicare enrollees from contributing to HSAs. The highest-risk obesity population — Medicare recipients on fixed Social Security income — cannot use this mechanism.',
                      source: 'IRS HSA eligibility rules — Publication 969',
                      grade: 'A',
                    },
                    {
                      label: 'Reduces preventive care in lower-income populations',
                      explanation: 'HSA plan enrollees reduce preventive care utilization by 35% — the opposite of what\'s needed for cardiovascular risk reduction. Cost-sharing reduces both unnecessary and necessary care equally.',
                      source: 'RAND Health Insurance Experiment — most rigorous study of cost-sharing effects',
                      grade: 'A',
                    },
                  ],
                },
                {
                  id: 'opt-personal-responsibility',
                  label: 'Personal responsibility and behavioral change',
                  pros: [
                    {
                      label: 'No external cost',
                      explanation: 'Behavioral change requires no government spending or mandate. Individuals retain full agency over their health decisions.',
                      source: 'Self-evident — not a contested empirical claim',
                      grade: 'B',
                    },
                    {
                      label: 'Behavioral interventions show real results',
                      explanation: 'Intensive lifestyle intervention shows 5-8% weight loss at 1 year in motivated participants — meaningful reduction in cardiovascular risk markers.',
                      source: 'Look AHEAD trial, NEJM, 2013',
                      grade: 'A',
                    },
                  ],
                  cons: [
                    {
                      label: 'Misidentifies the mechanism',
                      explanation: 'The hormonal evidence above establishes that obesity resistance is biological, not motivational. Framing a medical condition as a character failing reduces help-seeking behavior and worsens outcomes — documented in both obesity and addiction research.',
                      source: 'NEJM, Leibel 1995; AMA disease classification 2013; JAMA Internal Medicine, 2017',
                      grade: 'A',
                    },
                    {
                      label: '3x less effective than GLP-1 medications',
                      explanation: '5-8% behavioral weight loss vs 15-22% with GLP-1s. Behavioral approaches are valuable adjuncts but cannot match the biological intervention for severe obesity with cardiovascular risk.',
                      source: 'NEJM STEP trials vs Look AHEAD trial — direct comparison',
                      grade: 'A',
                    },
                  ],
                ...
                {
                  id: 'opt-deregulate',
                  label: 'Deregulate drug pricing',
                  pros: [
                    {
                      label: 'Market-based price reduction without mandates',
                      explanation: 'Removing price floors and allowing international reference pricing could reduce GLP-1 costs significantly. Consistent with the Inflation Reduction Act precedent already moving in this direction.',
                      source: 'CBO IRA score 2022; CEI analysis',
                      grade: 'B',
                    },
                    {
                      label: 'Addresses root cause of access gap',
                      explanation: '$1,349/month US vs $59/month Denmark is entirely a policy difference, not a manufacturing cost difference. Price deregulation attacks this gap directly.',
                      source: 'KFF international drug price comparison, 2024',
                      grade: 'A',
                    },
                  ],
                  cons: [
                    {
                      label: 'Alone insufficient for Medicare population on fixed income',
                      explanation: 'Even at $200/month (optimistic deregulation scenario), GLP-1s are unaffordable on median Social Security income of $1,800/month without coverage. Deregulation helps but doesn\'t solve the access problem for the highest-risk population.',
                      source: 'SSA average benefit data 2024; KFF affordability analysis',
                      grade: 'A',
                    },
                    {
                      label: 'May reduce R&D investment in future drugs',
                      explanation: 'Aggressive price deregulation reduces pharmaceutical R&D investment — contested on magnitude but directionally consistent across studies. Trade-off between current access and future innovation.',
                      source: 'NBER working papers on price controls and innovation',
                      grade: 'B',
                    },
                  ],
                },
                {
                  id: 'opt-subsidized-programs',
                  label: 'Subsidized behavioral weight loss programs',
                  pros: [
                    {
                      label: 'Addresses behavior and biology together',
                      explanation: 'Intensive programs combining behavioral counseling with medical support show better outcomes than either alone. The Diabetes Prevention Program is the gold standard.',
                      source: 'Diabetes Prevention Program, NEJM, 2002',
                      grade: 'A',
                    },
                    {
                      label: 'Lower cost than GLP-1 coverage',
                      explanation: 'DPP-style programs cost ~$500/person/year vs $12,000/person/year for GLP-1 coverage at current prices — dramatically more affordable to scale.',
                      source: 'CDC DPP cost analysis, 2023',
                      grade: 'A',
                    },
                  ],
                  cons: [
                    {
                      label: '3x less effective for severe obesity',
                      explanation: 'DPP shows 5-7% weight loss. GLP-1 shows 15-22%. For patients with severe obesity and established cardiovascular disease, behavioral programs alone are insufficient to meaningfully reduce mortality risk.',
                      source: 'AHRQ comparative effectiveness review, 2022',
                      grade: 'A',
                    },
                    {
                      label: 'High dropout rates limit population impact',
                      explanation: 'Dropout rates in behavioral programs are 30-50% within the first year — significantly limiting population-level impact despite strong per-participant outcomes.',
                      source: 'Look AHEAD trial retention data, 2013',
                      grade: 'A',
                    },
                  ],
                },
              ...
              whereThingsStand: [
                {
                  id: 'wts-personal-quiz',
                  branch: 'personal',
                  title: 'Take the obesity biology quiz',
                  description: 'Understanding the hormonal basis of obesity changes how you think and talk about it — reducing the stigma that prevents people from seeking help and building support for evidence-based policy solutions. Pass to earn a badge on your civic record.',
                  actions: [
                    { label: 'Take the quiz — 5 min', url: '/quiz/obesity-biology', type: 'quiz' },
                  ],
                  lastUpdated: 'July 2026',
                },
                {
                  id: 'wts-personal-doctor',
                  branch: 'personal',
                  title: 'Download this page to present to your doctor',
                  description: 'Walk into your next appointment with a one-page summary of the hormonal basis of obesity, the metabolic markers worth testing (fasting insulin, HbA1c, leptin), and why they matter for cardiovascular risk. Logged to your civic record when downloaded.',
                  actions: [
                    { label: 'Download doctor summary — PDF', type: 'download' },
                  ],
                  lastUpdated: 'July 2026',
                },
                {
                  id: 'wts-local-glp1',
                  branch: 'local',
                  title: 'Find GLP-1 access programs near you',
                  description: 'Several federally qualified health centers offer GLP-1 medications at reduced cost for uninsured and underinsured patients.',
                  locked: true,
                  lockedTier: 'community',
                  actions: [],
                  lastUpdated: 'July 2026',
                },
                {
                  id: 'wts-local-employer',
                  branch: 'local',
                  title: 'Advocate for GLP-1 coverage at your workplace',
                  description: 'Employee demand is the primary driver of employer GLP-1 coverage decisions. Ask your HR department about coverage.',
                  locked: true,
                  lockedTier: 'community',
                  actions: [],
                  lastUpdated: 'July 2026',
                ...
                {
                  id: 'wts-state-medicaid',
                  branch: 'state',
                  title: 'Contact your Georgia state rep about Medicaid GLP-1 coverage',
                  description: 'Georgia Medicaid does not cover GLP-1 medications for obesity. State-level coverage would reach ~180,000 Georgia Medicaid recipients.',
                  locked: true,
                  lockedTier: 'civic',
                  actions: [],
                  lastUpdated: 'July 2026',
                ...
                {
                  id: 'wts-legis-s2407',
                  branch: 'national_legislative',
                  title: 'S. 2407 — Treat and Reduce Obesity Act',
                  status: 'In committee — 34 of 51 Senate co-sponsors',
                  direction: 'toward',
                  description: 'Would extend Medicare coverage to GLP-1 obesity medications — the most direct legislative path to addressing the access gap documented above. 17 more co-sponsors needed to advance.',
                  billName: 'Treat and Reduce Obesity Act',
                  billNumber: 'S. 2407',
                  billStage: 'committee',
                  billStageCount: 34,
                  billStageTotal: 51,
                  billStageLabel: 'Senate co-sponsors of 51 needed',
                  senatorContext: [
                    {
                      name: 'Sen. Jon Ossoff',
                      position: 'not_cosponsored',
                      persuadability: 'Persuadable — no pharma or food industry PAC donations in 2024',
                      pacDonations: '$47,000 pharma PAC (small relative to peers)',
                      nextElection: 'November 2026',
                    },
                    {
                      name: 'Sen. Raphael Warnock',
                      position: 'not_cosponsored',
                      persuadability: 'Worth contacting — next election 2028 gives time to build pressure',
                      pacDonations: '$32,000 pharma PAC',
                      nextElection: 'November 2028',
                    },
                  ],
                  actions: [
                    { label: 'Contact Sen. Ossoff', url: 'https://www.ossoff.senate.gov/contact/', type: 'contact' },
                    { label: 'Contact Sen. Warnock', url: 'https://www.warnock.senate.gov/contact/', type: 'contact' },
                    { label: 'Sign petition — 8,432 of 25,000', url: '/petition/medicare-glp1', type: 'petition' },
                  ],
                  lastUpdated: 'July 2026',
                },
                {
                  id: 'wts-judicial-braidwood',
                  branch: 'national_judicial',
                  title: 'Braidwood v. Becerra — ACA preventive care mandate',
                  status: 'Before Supreme Court — decision expected 2025',
                  direction: 'mixed',
                  description: 'Supreme Court case challenging whether insurers must cover USPSTF-recommended preventive services without cost-sharing. If the ACA preventive mandate is struck down, GLP-1 coverage for prevention (not just treatment) would be at risk even if S. 2407 passes.',
                  actions: [
                    { label: 'Follow the case — SCOTUSblog', url: 'https://www.scotusblog.com', type: 'external' },
                  ],
                  lastUpdated: 'July 2026',
                },
                {
                  id: 'wts-exec-blocked',
                  branch: 'national_executive',
                  title: 'Medicare GLP-1 coverage blocked',
                  status: 'Blocked — Trump administration 2025',
                  direction: 'away',
                  description: 'Trump administration blocked Biden\'s 2024 proposal to extend Medicare coverage to GLP-1 medications for obesity. S. 2407 is now the only viable path — legislative action can override executive blocking.',
                  actions: [
                    { label: 'Support S. 2407 above — the legislative path is now the only path', type: 'external' },
                  ],
                  lastUpdated: 'July 2026',
                },
                {
                  id: 'wts-private-employers',
                  branch: 'private',
                  title: 'Employer GLP-1 coverage decisions',
                  status: 'Covering: Amazon, JPMorgan, Microsoft — Not covering: most mid-size employers',
                  description: 'Large employers are the largest purchasers of healthcare in the US — their coverage decisions affect more people than most state Medicaid programs. Employee demand is the documented primary driver of employer coverage expansion.',
                  actions: [
                    { label: 'Ask your HR about GLP-1 coverage — template email', type: 'download' },
                  ],
                  lastUpdated: 'July 2026',
                },
                {
                  id: 'wts-private-novonordisk',
                  branch: 'private',
                  title: 'Novo Nordisk pricing — $1,349/mo US vs $59/mo Denmark',
                  status: 'Same drug. Policy difference, not manufacturing cost.',
                  description: 'Novo Nordisk charges $1,349/month in the US vs $59/month in Denmark for the identical drug. The price difference is entirely a result of US drug pricing policy — not production costs. Supporting Medicare price negotiation is the most direct lever on this.',
                  actions: [
                    { label: 'Support Medicare drug price negotiation', url: 'https://www.congress.gov', type: 'contact' },
                  ],
                  lastUpdated: 'July 2026',
                },
              ],
