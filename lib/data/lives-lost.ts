  ...
  dataPoints: [
    {
      ...
      mechanism: 'Obesity causes cardiovascular death through two primary pathways. First, excess body fat increases blood volume and forces the heart to pump harder, causing hypertension that damages arterial walls over years. Second, visceral fat — the fat around organs — secretes inflammatory chemicals that accelerate atherosclerosis, the arterial plaque buildup that causes heart attacks and strokes. These two pathways interact and compound each other over decades before producing a fatal event.',
      why: 'The US obesity rate of 42% is nearly double the OECD average of 24%, and the gap has widened every decade since 1980. This is not explained by individual willpower — peer nations have similar genetics and similar knowledge of nutrition. The difference is the food environment Americans live in, which is shaped by subsidy policy, marketing regulation, and urban design.',
      ...
      incentiveNote: 'Ultra-processed foods carry 3x the profit margin of whole foods. The food industry has every financial incentive to produce, market, and lobby to protect the foods that cause obesity — and has done so successfully for 40 years.',
      chartLabel: 'Adult obesity rate (%)',
      chart: [
        { year: 1990, us: 12, peer: 10, target: 15 },
        { year: 1995, us: 16, peer: 12, target: 15 },
        { year: 2000, us: 20, peer: 14, target: 15 },
        { year: 2005, us: 26, peer: 16, target: 15 },
        { year: 2010, us: 30, peer: 19, target: 15 },
        { year: 2015, us: 34, peer: 21, target: 15 },
        { year: 2019, us: 38, peer: 23, target: 15 },
        { year: 2022, us: 42, peer: 24, target: 15 },
      ],
      trust: {
        grade: 'A',
      ...
      drivers: [
        ...
        {
          id: 'cv-ob-d2',
          label: 'Ultra-processed food marketing to children',
          stat: 'Food companies spend $1.8B annually marketing to children under 12, overwhelmingly for products high in sugar, salt, and saturated fat',
          why: 'Brand loyalty established in childhood is worth billions in lifetime consumer value. Children are targeted because they are neurologically less capable of evaluating advertising persuasion and more likely to influence parental purchasing. The US has no binding restrictions on food marketing to children — the industry operates a voluntary self-regulation system it designed and monitors itself, which independent research consistently finds ineffective. The EU, UK, and Canada have stronger mandatory restrictions.',
          actions: [
            ...
            { tier: 'systemic', text: 'Support mandatory restrictions on food marketing to children under 12' },
          ],
        },
        {
          id: 'cv-ob-d3',
          ...
          why: 'US agricultural subsidies were designed in the New Deal era and restructured in the 1970s to incentivize maximum commodity production. Three forces keep them in place: First, concentrated benefits — a small number of large agricultural corporations receive the majority of subsidy payments and have enormous financial incentive to lobby for preservation. Second, Senate math — Iowa, Nebraska, and Kansas have the same two senators as California despite a fraction of the population, giving commodity crop states disproportionate power in Farm Bill negotiations. Third, the revolving door — USDA leadership routinely comes from and returns to agribusiness.',
          actions: [
