...
export const livesLostRing: Ring = {
  ...
  {
    tier: 'personal',
    text: 'Learn to identify ultra-processed foods using the NOVA classification system',
    whyItMatters: 'Reducing your personal demand for ultra-processed foods weakens the financial case for producing and marketing them — and every consumer who switches sends a market signal.',
    startHere: 'https://www.fao.org/nutrition/education/food-dietary-guidelines/background/nova/en/',
    startHereLabel: 'Learn the NOVA system — 10 min read',
    consequence: 'If 10% of Americans shifted away from ultra-processed foods, industry revenue would drop enough to reduce lobbying budgets and shift R&D toward healthier products.',
    timeEstimate: '10 min to learn, ongoing to apply',
  },
  {
    tier: 'local',
    text: 'Advocate for stronger school food standards in your district',
    whyItMatters: 'Children exposed to ultra-processed food marketing in schools develop brand loyalty that persists into adulthood. School food standards are one of the few places where government directly counters industry marketing.',
    startHere: 'https://www.schoolnutrition.org/advocacy/',
    startHereLabel: 'Find your school board meeting',
    consequence: 'Districts that have adopted stronger food standards see measurable improvements in student nutrition within one school year.',
    timeEstimate: '2 hours for a school board meeting',
  },
  {
    tier: 'national',
    text: 'Support mandatory restrictions on food marketing to children',
    whyItMatters: 'The $1.8B spent annually marketing unhealthy food to children is the primary driver of early brand loyalty and lifetime consumption patterns. Mandatory restrictions — as implemented in the EU, UK, and Canada — directly address this incentive.',
    consequence: 'Countries with mandatory restrictions on child-directed food marketing have seen measurably slower growth in childhood obesity rates compared to the US.',
    timeEstimate: '10 min to contact your representative',
  },
],
    },
    {
      ...
      actions: [
  {
    ...
    whyItMatters: 'Cooking from scratch reduces your dependence on ultra-processed convenience foods regardless of where you live — and builds the skills that make healthy eating sustainable long-term.',
    startHere: 'https://www.budgetbytes.com',
    startHereLabel: 'Budget Bytes — affordable whole food recipes',
    consequence: 'Households that cook from scratch 5+ days per week consume significantly less sodium, sugar, and saturated fat than those relying on processed foods.',
    timeEstimate: '30-60 min per meal, decreases with practice',
  },
  {
    tier: 'local',
    text: 'Attend your city council planning meeting and advocate for grocery store zoning',
    whyItMatters: 'Grocery store location decisions are influenced by zoning laws set at the city level. Public comment at planning meetings directly influences council votes on zoning incentives for underserved areas.',
    startHere: 'https://www.municode.com',
    startHereLabel: 'Find your city council meeting schedule',
  ...
  {
    tier: 'national',
    text: 'Support SNAP expansion for farmers markets and produce incentive programs',
    whyItMatters: 'SNAP acceptance at farmers markets dramatically increases healthy food access in food deserts without requiring new grocery stores. The Double Up Food Bucks program has demonstrated measurable impact in states where it operates.',
    startHere: 'https://doubleupamerica.org',
    startHereLabel: 'Learn about Double Up Food Bucks',
    consequence: 'If SNAP produce incentives were expanded nationally, an estimated 8 million SNAP recipients would gain meaningful access to fresh fruits and vegetables.',
    timeEstimate: '10 min to contact your representative',
  },
],
    },
  ...
  {
    tier: 'personal',
    text: 'Buy whole foods over processed products when possible',
    whyItMatters: 'Agricultural subsidies follow demand signals over time. Consumer shift toward whole foods puts market pressure on the subsidy structure by reducing the profitability of commodity-derived ultra-processed products.',
    startHere: 'https://www.ewg.org/foodscores',
    startHereLabel: 'EWG Food Scores — find better options',
    consequence: 'Market research shows that sustained consumer preference shifts do influence agricultural investment patterns within 5-10 years.',
    timeEstimate: 'Ongoing — integrate into regular shopping',
  },
  {
    tier: 'local',
    text: 'Support local farms directly through CSA subscriptions or farmers markets',
    whyItMatters: 'Local farm revenue that bypasses commodity markets reduces dependence on subsidy-dependent commodity crops and strengthens the economic case for diversified agriculture.',
    startHere: 'https://www.localharvest.org',
    startHereLabel: 'Find a CSA near you',
    consequence: 'Communities with strong local food economies have measurably more diverse agricultural production and lower rates of food insecurity.',
    timeEstimate: '1 hour to research and sign up',
  },
  {
    tier: 'national',
    text: 'Contact your senators about the Farm Bill — next reauthorization is 2028',
    whyItMatters: 'The Farm Bill is renegotiated every 5 years and determines subsidy structure for the entire agricultural economy. It is the single highest-leverage food policy moment available — and most constituents never contact their senators about it.',
    startHere: 'https://www.congress.gov/bill/118th-congress/house-bill/4107',
    startHereLabel: 'View the Healthy Food Policy Act (HR 4107)',
    consequence: 'Redirecting 10% of commodity subsidies toward fruits and vegetables would increase national fruit and vegetable consumption by an estimated 6.9% — with measurable cardiovascular mortality reduction within a decade.',
    timeEstimate: '10 min',
    legislation: {
      ...
      url: 'https://www.congress.gov/bill/118th-congress/house-bill/4107',
  ...
  {
    tier: 'personal',
    text: 'Treat stress management as cardiovascular disease prevention — not a luxury',
    whyItMatters: 'Chronic stress directly drives visceral fat accumulation through cortisol — the same fat that causes heart attacks. Stress reduction is not self-care, it is evidence-based cardiovascular medicine.',
    startHere: 'https://www.heart.org/en/healthy-living/healthy-lifestyle/stress-management',
    startHereLabel: 'AHA stress management guide',
  ...
  },
  {
    ...
    whyItMatters: 'The stress-obesity link means that economic precarity is a direct cardiovascular risk factor. Policies that reduce poverty, housing insecurity, and financial stress have measurable downstream effects on cardiovascular mortality.',
    consequence: 'Studies show that a $1,000 increase in annual household income is associated with a measurable reduction in obesity rates and cardiovascular risk markers — the link between economic security and cardiovascular health is direct and documented.',
    timeEstimate: '10 min to contact your representative',
  },
],
    },
