...
export const livesLostRing: Ring = {
  ...
  chartLabel: 'Preventable CV deaths (thousands per year)',
  systemicIncentive: 'The US healthcare system generates more revenue treating heart attacks than preventing them. A cardiologist performing a stent procedure earns 10x what a primary care physician earns delivering preventive counseling. The system is financially structured to treat disease, not prevent it — and the agricultural subsidy system makes the food that causes heart disease artificially cheap.',
  chart: [
  ...
  dataPoints: [
    {
      id: 'cv-prev', label: 'Preventable deaths/yr', value: '~200,000',
      note: '80% of heart disease is preventable',
      ...
      source: 'CDC WONDER, IHME', unit: 'deaths/yr',
      nextDataRelease: 'January 2026 — CDC WONDER annual mortality release',
      trend: 'down', trendIsGood: true,
      impactWeight: 'primary',
      incentiveNote: 'Pharmaceutical companies profit more from managing chronic heart disease than curing it — creating a structural disincentive for prevention-focused research.',
      chartLabel: 'Preventable CV deaths (thousands per year)',
      chart: [
        { year: 2000, us: 320, peer: 165, target: 0 },
        { year: 2005, us: 300, peer: 155, target: 0 },
        { year: 2010, us: 275, peer: 140, target: 0 },
        { year: 2015, us: 240, peer: 125, target: 0 },
        { year: 2019, us: 215, peer: 112, target: 0 },
        { year: 2022, us: 200, peer: 105, target: 0 },
      ],
      ...
      solvedPrecedent: {
        ...
        description: 'In 1965, 42% of American adults smoked. Today it\'s 11%. This was achieved through tobacco taxes, advertising restrictions, public education campaigns, and smoke-free workplace laws — all opposed by industry at every step.',
        outcome: 'Estimated 8 million premature deaths prevented between 1964 and 2012.',
    ...
    {
      id: 'cv-food', label: 'Food desert exposure', value: '23.5 million people',
      note: 'Limited healthy food access drives disease',
      ...
      source: 'USDA Economic Research Service', unit: 'million people',
      nextDataRelease: 'March 2026 — USDA Food Access Research Atlas update',
      trend: 'stable', trendIsGood: false,
      impactWeight: 'primary',
      incentiveNote: 'Grocery chains face no financial incentive to open in low-income areas — they are more profitable in wealthy neighborhoods. Without zoning requirements or subsidies, the market systematically underserves communities that need healthy food most.',
      chartLabel: 'Food desert population (millions of people)',
      chart: [
        { year: 2000, us: 18, peer: 8, target: 0 },
        { year: 2005, us: 20, peer: 8, target: 0 },
        { year: 2010, us: 22, peer: 8, target: 0 },
        { year: 2015, us: 23, peer: 8, target: 0 },
        { year: 2019, us: 23.5, peer: 8, target: 0 },
        { year: 2022, us: 23.5, peer: 8, target: 0 },
      ],
    ...
    {
      id: 'cv-uninsured', label: 'Uninsured with heart conditions', value: '~8 million people',
      note: 'Delayed care dramatically worsens outcomes',
      ...
      source: 'Kaiser Family Foundation', unit: 'million people',
      nextDataRelease: 'April 2026 — KFF annual uninsured rate report',
      trend: 'down', trendIsGood: true,
      impactWeight: 'primary',
      incentiveNote: 'The insurance industry profits from excluding high-risk patients. Before the ACA, pre-existing condition exclusions were standard practice — denying coverage to the people who needed it most was the business model.',
      chartLabel: 'Uninsured with heart conditions (millions)',
      chart: [
        { year: 2010, us: 14, peer: 0, target: 0 },
        { year: 2013, us: 13, peer: 0, target: 0 },
        { year: 2015, us: 10, peer: 0, target: 0 },
        { year: 2017, us: 9, peer: 0, target: 0 },
        { year: 2019, us: 9, peer: 0, target: 0 },
        { year: 2022, us: 8, peer: 0, target: 0 },
      ],
    ...
    {
      id: 'cv-air', label: 'Air pollution cardiovascular deaths', value: '~85,000 per year',
      note: 'PM2.5 is a direct cardiovascular risk factor',
      ...
      source: 'EPA, Lancet', unit: 'deaths/yr',
      nextDataRelease: 'June 2026 — EPA National Air Quality Report',
      trend: 'down', trendIsGood: true,
      impactWeight: 'secondary',
      incentiveNote: 'Industrial emitters externalize health costs onto surrounding communities with no direct financial penalty. The cost of cardiovascular deaths from pollution is borne by individuals, families, and the healthcare system — not the polluters.',
      chartLabel: 'Air pollution cardiovascular deaths (thousands per year)',
      chart: [
        { year: 2000, us: 110, peer: 40, target: 0 },
        { year: 2005, us: 105, peer: 38, target: 0 },
        { year: 2010, us: 100, peer: 35, target: 0 },
        { year: 2015, us: 92, peer: 32, target: 0 },
        { year: 2019, us: 88, peer: 30, target: 0 },
        { year: 2022, us: 85, peer: 29, target: 0 },
      ],
  ...
  solutions: [
    {
      ...
      proximity: 'close',
      description: 'Countries with universal coverage achieve preventable CV death rates 40–60% below the US. People get statins and blood pressure medication before heart attacks, not after.',
      progress: 65, progressColor: '#1D9E75',
      actions: ['Advocate for Medicare expansion', 'Support ACA protection', 'Contact your senator'],
    },
    {
      name: 'Food system reform',
      proximity: 'medium',
      description: 'Reforming agricultural subsidies and restricting junk food marketing to children would reduce CV disease rates measurably within a decade.',
      progress: 30, progressColor: '#BA7517',
      actions: ['Engage in Farm Bill advocacy', 'Support sugar tax initiatives'],
    },
  ],
},
    {
